...
# Serverless module
#
# - Private S3 bucket: bedrock-assets-<student-id>
# - Lambda: bedrock-asset-processor (Python) that logs uploaded filenames
# - S3 ObjectCreated event notification -> Lambda
###############################################################################

# --- S3 assets bucket (private) ---------------------------------------------
